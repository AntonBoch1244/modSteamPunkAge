package alekc.mods.steampunk.generators;

import alekc.mods.steampunk.registry.blocks;
...
public class nickelOreGenerator implements IWorldGenerator
{
    @Override
    ...
    {
        this.addOreSpawn(blocks.nickelOre, world, random, x, z, 16, 16, 4 + random.nextInt(5), 10, 15, 50);
    }
